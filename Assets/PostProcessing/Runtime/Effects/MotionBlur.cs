...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    internal sealed class MotionBlurRenderer : PostProcessEffectRenderer<MotionBlur>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            RenderTextureFormat packedRTFormat;

            if (settings.fastMode.value && RenderTextureFormat.ARGB1555.IsSupported())
            {
                packedRTFormat = RenderTextureFormat.ARGB1555;
            }
            else if (RenderTextureFormat.ARGB2101010.IsSupported())
            {
                packedRTFormat = RenderTextureFormat.ARGB2101010;
            }
            else
            {
                packedRTFormat = RenderTextureFormat.ARGB32;
            }
