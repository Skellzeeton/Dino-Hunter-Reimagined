...
public class RemoveMeshTangentsEditor : EditorWindow
{
    private Mesh sourceMesh;
    private bool overwriteOriginal = false;

    [MenuItem("Tools/Remove Mesh Tangents")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow(typeof(RemoveMeshTangentsEditor), false, "Remove Tangents");
    }

    private void OnGUI()
    {
        GUILayout.Label("Strip Tangents from Mesh", EditorStyles.boldLabel);
        ...
        if (GUILayout.Button("Remove Tangents"))
        {
    ...
    private void ProcessMesh(Mesh inputMesh)
    {
        ...
        Mesh stripped = StripTangents(inputMesh);
        stripped.name = inputMesh.name + "_NoTangents";
    ...
    private Mesh StripTangents(Mesh mesh)
    {
        Mesh newMesh = new Mesh();
        newMesh.name = mesh.name + "_NoTangents";
