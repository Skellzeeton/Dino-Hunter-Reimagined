...
public class LevelPointEx : MonoBehaviour
{
	...
	public void SetLevelPointState(LevelPointExState m_level_point_state)
	{
		...
		if (level_point_state == LevelPointExState.Passed)
		{
			...
			btn_level.Reset();
			img_bottom.gameObject.SetActiveRecursive(true);
			if (img_lock != null)
			{
		...
		else if (level_point_state == LevelPointExState.Hide)
		{
			btn_level.Disable(true);
			btn_level.gameObject.SetActiveRecursive(false);
			img_bottom.gameObject.SetActiveRecursive(false);
			if (img_lock != null)
			{
				img_lock.gameObject.SetActiveRecursive(false);
			}
	...
	public void ShowWay()
	{
		...
		{
			img_way.gameObject.SetActiveRecursive(true);
		}
	}
	...
	public void HideWay()
	{
		...
		{
			img_way.gameObject.SetActiveRecursive(false);
		}
	}
