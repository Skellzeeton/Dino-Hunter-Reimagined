...
public class CCharBossPterodactyl : CCharBoss
{
	...
	public override void InitAnimData()
	{
		...
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Mob_DeadHeadShoot, "Ptero_death01"));
		...
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Mob_ShowTime, "Ptero_exit"));
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Skill_Action_1, "Ptero_attack02_01"));
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Skill_Action_2, "Ptero_attack02_02"));
