...
public class AchievementStars : MonoBehaviour
{
	...
	public void SetInfo(AchievementLevelType m_level)
	{
		...
		case AchievementLevelType.Level0:
			img_star01.gameObject.SetActiveRecursive(false);
			img_star02.gameObject.SetActiveRecursive(false);
			img_star03.gameObject.SetActiveRecursive(false);
			break;
		case AchievementLevelType.Level1:
			img_star01.gameObject.SetActiveRecursive(true);
			img_star02.gameObject.SetActiveRecursive(false);
			img_star03.gameObject.SetActiveRecursive(false);
			break;
		case AchievementLevelType.Level2:
			img_star01.gameObject.SetActiveRecursive(true);
			img_star02.gameObject.SetActiveRecursive(true);
			img_star03.gameObject.SetActiveRecursive(false);
			break;
		case AchievementLevelType.Level3:
			img_star01.gameObject.SetActiveRecursive(true);
			img_star02.gameObject.SetActiveRecursive(true);
			img_star03.gameObject.SetActiveRecursive(true);
			break;
		}
	}
