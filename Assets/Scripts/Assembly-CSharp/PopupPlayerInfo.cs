...
public class PopupPlayerInfo : MonoBehaviour
{
	...
	public void SetInfo(TUICoopPlayerInfo m_coop_player_info)
	{
		...
		if (label_HunterLV != null)
		{
			...
			{
				label_HunterLV.Text = "LV." + coop_player_info.hunter_level.ToString();
			}
		}
		if (label_HunterLV_Exp != null)
		{
			label_HunterLV_Exp.Text = "LV.EXP:" + coop_player_info.hunter_exp + "/" + coop_player_info.hunter_update_exp;
		}
