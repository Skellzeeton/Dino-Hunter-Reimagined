...
public class iBehaviorCenter
{
	...
	protected void CreateBehavior1()
	{
		...
		CompositeNode_Selector attackOrReposition = new CompositeNode_Selector();
		CompositeNode_Sequence repositionSeq = new CompositeNode_Sequence();
		repositionSeq.AddChild(new lgTooCloseToTargetNode());
		repositionSeq.AddChild(new doSetRepositionPathNode());
		repositionSeq.AddChild(new doMoveToNode());
		attackOrReposition.AddChild(repositionSeq);
		attackOrReposition.AddChild(new doUseSkillNode());
		compositeNode_Sequence15.AddChild(attackOrReposition);
	...
	protected void CreateBehavior2()
	{
		...
		attackOrReposition.AddChild(repositionSeq);
		attackOrReposition.AddChild(new doUseSkillNode());
		compositeNode_Sequence9.AddChild(attackOrReposition);
	...
	protected void CreateBehavior102()
	{
		...
		attackOrReposition.AddChild(repositionSeq);
		attackOrReposition.AddChild(new doUseSkillNode());
		compositeNode_Sequence8.AddChild(attackOrReposition);
		CompositeNode_Sequence compositeNode_Sequence9 = new CompositeNode_Sequence();
