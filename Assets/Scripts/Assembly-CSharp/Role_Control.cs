...
public class Role_Control : MonoBehaviour
{
	...
	public Transform prefab_weapon_020;
	...
	public void ChangeWeapon(int m_id)
	{
		...
		{
			weapon_id = m_id;
			weapon_now.gameObject.SetActiveRecursive(true);
	...
	public void Show(bool bShow)
	{
		if (!(role_now == null))
		{
			role_now.gameObject.SetActiveRecursive(bShow);
			m_bActive = bShow;
		}
	}
	...
	private string GetAnimName(WeaponType weapontype, bool isattack = false)
	{
		...
		case WeaponType.ViolenceGun:
			result = ((!isattack) ? "shootgun_ground_idle" : "shootgun_ground_attack01_menu");
			break;
		}
		return result;
	}
	...
	public void SetBottomShow(bool m_show, int m_layer = 0)
	{
		...
		{
			plane_bottom.gameObject.SetActiveRecursive(m_show);
