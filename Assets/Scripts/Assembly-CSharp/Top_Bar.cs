...
public class Top_Bar : MonoBehaviour
{
	...
	public void SetBtnBackShow(bool m_show)
	{
		...
		{
			btn_back.gameObject.SetActiveRecursive(true);
			btn_back.Reset();
		}
		else
		{
			btn_back.gameObject.SetActiveRecursive(false);
		}
	}
	...
	public void SetBtnGoldShow(bool m_show)
	{
		...
		{
			btn_gold.gameObject.SetActiveRecursive(true);
			btn_gold.Reset();
		}
		else
		{
			btn_gold.gameObject.SetActiveRecursive(false);
		}
	}
	...
	public void SetBtnCrystalShow(bool m_show)
	{
		...
		{
			btn_crystal.gameObject.SetActiveRecursive(true);
			btn_crystal.Reset();
		}
		else
		{
			btn_crystal.gameObject.SetActiveRecursive(false);
		}
	}
