...
public class PopupEquipFrame : MonoBehaviour
{
	...
	private void Start()
	{
		...
		{
			items_weapon.transform.localPosition = new Vector3(-1000f, -125f, items_weapon.transform.localPosition.z);
		}
		if (items_armor != null)
		{
			items_armor.transform.localPosition = new Vector3(-1000f, -125f, items_armor.transform.localPosition.z);
		}
		if (items_accessory != null)
		{
			items_accessory.transform.localPosition = new Vector3(-1000f, 125f, items_accessory.transform.localPosition.z);
		}
	}
