...
public class AchievementRewardText : MonoBehaviour
{
	...
	public void Show(int m_value01, UnitType m_type01)
	{
		...
		{
			label_value01.gameObject.SetActiveRecursive(true);
			label_value01.Text = "x" + m_value01;
			label_value01.transform.localPosition = new Vector3(-15f, 0f, 0f);
		}
		if (img_unit01 != null)
		{
			img_unit01.gameObject.SetActiveRecursive(true);
			switch (m_type01)
			{
			case UnitType.Gold:
		...
		{
			label_value02.gameObject.SetActiveRecursive(false);
		}
		if (img_unit02 != null)
		{
			img_unit02.gameObject.SetActiveRecursive(false);
		}
	}
	...
	public void Show(int m_value01, UnitType m_type01, int m_value02, UnitType m_type02)
	{
		...
		if (label_value02 != null)
		{
			label_value02.gameObject.SetActiveRecursive(true);
			label_value02.Text = "x" + m_value02;
			label_value02.transform.localPosition = new Vector3(10f, 0f, 0f);
		}
		if (img_unit02 != null)
		{
			img_unit02.gameObject.SetActiveRecursive(true);
			switch (m_type02)
			{
			case UnitType.Gold:
