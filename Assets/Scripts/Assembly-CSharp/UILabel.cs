...
public class UILabel : UIWidget
{
	...
	protected override void OnStart()
	{
		...
		if (mLabelColor == Color.white)
		{
			mLabelColor = base.color;
		}
	}
	...
	public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		case Pivot.BottomLeft:
			mFont.Print(processedText, mLabelColor, verts, uvs, cols, mEncoding, mSymbols, UIFont.Alignment.Left, 0);
			break;
		case Pivot.TopRight:
		case Pivot.Right:
